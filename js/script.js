...
const marco = {
    ...
    age: 24,
    bio: ["2017-2023 : Presque 6 ans passés à travailler dans la Grande Distribution (dont 4,5 années à Intermarché);", "2019/2021 : Bac STMG et BTS MCO (Management Commercial Opérationnel);", "2021 : Une expérience de création d'une entreprise avec 2 associés (E-commerce)."],
    softSkills: ["Proactivité", "Esprit d’équipe et communication", "Logique", "Pensée critique", "Patience"],
    hardSkills: ["HTML", "CSS", "JavaScript", "React", "Node.js"],
    resonsWhyDev: "Reconversion : J'ai découvert le dev par hasard et j'ai tout de suite accroché. Je me suis lancé dans le dev web pour avoir un travail que j'aime, dans lequel je suis épanoui et qui me donne plus de liberté.",
    objectives: "J'aimerais poursuivre ma formation avec une alternance à la Wild afin de m'insérer dans le marché du dev avec déjà une expérience en poche et des compétences plus avancées.",
    projects: [],
    gitHub: "https://github.com/HazeFury",
    linkedIn: "https://www.linkedin.com/in/marc-antoine-berger/",
    mail: "mab.dev69@gmail.com",
};
...
const françois = {
    ...
    softSkills: ["Autonomie et capacité d’adaptation", "Organisation", "Esprit d’équipe et communication", "Logique", "Pensée critique"],
    ...
    linkedIn: "https://www.linkedin.com/in/fran%C3%A7ois-chavallard-2979b93b/",
...
const lucie = {
    ...
    softSkills: ["Autonomie et capacité d’adaptation", "Organisation", "Esprit d’équipe et communication", "Logique", "Patience"],
    hardSkills: ["HTML", "CSS", "JavaScript", "React", "Node.js"],
...
const aurelie = {
    ...
    softSkills: ["Autonomie et capacité d’adaptation", "Organisation", "Esprit d’équipe et communication", "Patience", "Ouverture d’esprit"],
    hardSkills: ["HTML", "CSS", "JavaScript", "React", "Node.js", "Python"],
...
const anthony = {
    ...
    softSkills: ["Autonomie et capacité d’adaptation", "Proactivité", "Esprit d’équipe et communication", "Flexibilité cognitive", "Ouverture d’esprit"],
    hardSkills: ["HTML", "CSS", "JavaScript", "React", "Node.js"],
...
const marcelo = {
    ...
    softSkills: ["Autonomie et capacité d’adaptation", "Organisation", "Proactivité", "Pensée critique", "Patience"],
    hardSkills: ["HTML", "CSS", "JavaScript", "React", "Node.js", "Python"],
...
const guillaume = {
    ...
    softSkills: ["Autonomie et capacité d’adaptation", "Organisation", "Patience", "Ouverture d’esprit", "Créativité"],
    hardSkills: ["HTML", "CSS", "JavaScript", "React", "Node.js"],
    ...
    linkedIn: "https://www.linkedin.com/in/guillaume-lamourec/",
    mail: "guillaume.lamourec@outlook.com",
};
...
const jawad = {
    ...
    softSkills: ["Autonomie et capacité d’adaptation", "Organisation", "Logique", "Patience", "Connaissance de soi"],
    hardSkills: ["HTML", "CSS", "JavaScript", "React", "Node.js"],
...
const pierre = {
    ...
    softSkills: ["Autonomie et capacité d’adaptation", "Proactivité", "Esprit d’équipe et communication", "Créativité"],
    hardSkills: ["HTML", "CSS", "JavaScript", "React", "Node.js"],
    ...
    for (let wilder of wilders) {
        if (tempWildersArray.includes(wilder.identifier)) {
            ...
            for (let i = 0; i < wilder.hardSkills.length; i++) {
                ...
                } else if (wilder.hardSkills[i] === "CSS") {
                    createLanguageIcon("CSS");
            ...
            function createProfilePage() {
                if (activeProfile === false) {
                    ...
                    mailIcon.href = "mailto:" + wilder.mail;
...
for (let i = 0; i < hardSkillsGlobalArray.length; i++) {
    if (hardSkillsGlobalArray[i] === "HTML") {
        createLanguageIcon("HTML");
    } else if (hardSkillsGlobalArray[i] === "CSS") {
        createLanguageIcon("CSS");
